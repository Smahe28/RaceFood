<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CancelOrders.aspx.cs" Inherits="RaceFood.Admin.CancelOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
         <div class="row" id="searchrow" runat="server">
            ...
            <div class="col-md-10">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ForeColor="black" HeaderStyle-BackColor="#006666" HeaderStyle-ForeColor="White" CssClass="table">
                    <Columns>
                        ...
                        <asp:BoundField DataField="CancelTime" HeaderText="CancelTime" />
