<%@ Page Title="" Language="C#" MasterPageFile="~/DeliveryBoys/DeliveryBoyMaster.Master" AutoEventWireup="true" CodeBehind="OrdersPage.aspx.cs" Inherits="RaceFood.DeliveryBoys.OrdersPage" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ForeColor="black" HeaderStyle-BackColor="#006666" HeaderStyle-ForeColor="White" CssClass="table">
                    <Columns>
                      ...
                      <asp:TemplateField HeaderStyle-BackColor="#006666" HeaderText="Cancel">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkFinish" runat="server" CssClass="btn btn-danger" CommandArgument='<%# Eval("ID") %>' OnClick="LinkFinish_Click" >Finished</asp:LinkButton>
                            </ItemTemplate>
